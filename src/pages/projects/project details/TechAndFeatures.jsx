...
const TechAndFeatures = ({project}) => {
  return (
    <div className="soft-bg-gradient dark:dark-bg-gradient flex items-center gap-4 rounded-lg p-3">
      <div className="dark:hover:border-gold  border-deep-gold dark:border-gold/50 flex w-full scale-100 items-center gap-4 rounded-lg border-1 px-4 py-3 hover:scale-[1.02]">
